        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center">
                ...
                <div class="mt-10 flex flex-col sm:flex-row gap-4 justify-center items-center">
                    <a href="{{ route('stories.index')  }}" class="inline-flex items-center px-8 py-4 text-lg font-semibold rounded-full bg-forest-green text-white hover:bg-forest-green/90 transform hover:scale-105 transition-all duration-300 shadow-xl hover:shadow-2xl">
