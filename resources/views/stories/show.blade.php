<x-stories-layout>
    <div class="max-w-3xl mx-auto bg-white/80 backdrop-blur-sm rounded-2xl shadow-sm border border-stone-200 overflow-hidden">
        @if($story->cover_image_path)
            @php
                ...
                $coverUrl = Str::startsWith($path, 'demo/')
                    ...
                    : asset('storage/'.$path);
            @endphp
            <img src="{{ $coverUrl }}" alt="" class="w-full h-80 object-cover">
        @endif
        ...
        <div class="p-8">
            ...
            <div class="prose prose-stone max-w-none leading-relaxed text-lg">
                {!! nl2br(e($story->body)) !!}
            </div>
            ...
            @if($story->latitude && $story->longitude)
                ...
                <div id="story-map" class="w-full h-64 rounded-xl shadow-sm border border-stone-200 mb-8"></div>
            @endif
    ...
    <div class="max-w-3xl mx-auto mt-12 bg-white/70 backdrop-blur-sm border border-stone-200 rounded-2xl p-8 shadow-sm" id="comments">
