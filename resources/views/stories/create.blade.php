        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <h3 class="text-lg font-medium mb-4">Nauja istorija</h3>
                    ...
                    <form method="POST" action="{{ route('stories.store') }}" class="space-y-4">
                        ...
                        <div>
                            ...
                            <textarea name="body" rows="10"
                                      class="w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100" required>{{ old('body') }}</textarea>
                        </div>

                        <div class="flex items-center gap-3">
                            <button class="px-4 py-2 rounded-md bg-blue-600 text-white hover:bg-blue-700">Išsaugoti</button>
                            <a href="{{ route('stories.index') }}" class="text-sm text-gray-600 dark:text-gray-300 hover:underline">Atšaukti</a>
                        </div>
                    </form>
                </div>
            </div>
