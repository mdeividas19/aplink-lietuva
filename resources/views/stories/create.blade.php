<x-stories-layout>
    <div class="max-w-3xl mx-auto">
        <div class="bg-white/80 backdrop-blur-sm shadow-xl rounded-2xl p-8 border border-stone-200">
            ...
            <h1 class="text-4xl font-serif mb-8">Nauja istorija</h1>
            ...
            <form method="POST" action="{{ route('stories.store') }}" enctype="multipart/form-data" class="space-y-6">
                ...
                <label class="flex items-center gap-2 bg-stone-100 hover:bg-stone-200 transition rounded-full px-3 py-1 cursor-pointer">Žymos</label>
                ...
                <div class="flex items-center gap-3">
                    <button class="px-5 py-2.5 rounded-lg bg-stone-900 text-white shadow hover:bg-stone-800 transition">Išsaugoti</button>
                    <a href="{{ route('stories.index') }}" class="text-stone-600 hover:text-stone-900 underline-offset-2 hover:underline">Atšaukti</a>
                </div>
