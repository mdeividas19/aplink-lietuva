                        ...
                        <table class="min-w-full text-sm">
                            <thead>
                                <tr class="text-left text-baltic-blue-800">
                                    ...
                                    <th class="px-4 py-3 font-semibold bg-baltic-blue-50">Username ID</th>
                                    <th class="px-4 py-3 font-semibold bg-baltic-blue-50">Location ID</th>
                                    <th class="px-4 py-3 font-semibold bg-baltic-blue-50">Rating</th>
                                    <th class="px-4 py-3 font-semibold bg-baltic-blue-50">Comment</th>
                            ...
                            <tbody class="divide-y divide-gray-100">
                                ...
                                <tr class="hover:bg-amber-50">
                                    <td class="px-4 py-3 text-gray-700">{{$review->id}}</td>
                                    <td class="px-4 py-3 text-gray-900 font-medium">{{$review->user_id}}</td>
                                    <td class="px-4 py-3 text-gray-700">{{$review->location_id}}</td>
                                    <td class="px-4 py-3 text-gray-700">{{$review->rating}}</td>
                                    <td class="px-4 py-3 text-gray-700">{{$review->comment}}</td>
                                    <td class="px-4 py-3 text-gray-700">{{$review->created_at}}</td>
                                    <td class="px-4 py-3">
                                    ...
                                    <td class="px-4 py-3">
                                        <a
                                            href='{{ route("admin.editReview", $review->id) }}'
